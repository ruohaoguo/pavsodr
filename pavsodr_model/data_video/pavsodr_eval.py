...
import torch
from .datasets.pavsodr_api.pavsodr import PAVSODR
from .datasets.pavsodr_api.pavsodreval import PAVSODReval
...
class PAVSODREvaluator(DatasetEvaluator):
    """
    ...
    def __init__(
        ...
        *,
        ...
        with contextlib.redirect_stdout(io.StringIO()):
            self._pavsodr_api = PAVSODR(json_file)

        # Test set json files do not contain annotations (evaluation must be
        # performed using the COCO evaluation server).
        self._do_evaluation = "annotations" in self._pavsodr_api.dataset
    ...
    def _eval_predictions(self, predictions):
        ...
        """
        self._logger.info("Preparing results for PAVSODR format ...")
...
def instances_to_coco_json_video(inputs, outputs):
    ...
    for instance_id, (s, l, m) in enumerate(zip(scores, labels, masks)):
        ...
        pavsodr_results.append(res)

    return pavsodr_results
...
def _evaluate_predictions_on_coco(
    ...
    coco_eval = PAVSODReval(coco_gt, coco_dt)
